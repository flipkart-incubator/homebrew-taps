...
class Jumphost < Formula
  ...
  url "https://storage.googleapis.com/brew-jumphost/jumphost-install-v3.0.tar.gz", :using => CurlIPv4DownloadStrategy
  version "3.0"
  sha256 "ad5e70209407559ddad827f27f817c50e6cdd8a41961bd0879a2b634f1f28b3c"
